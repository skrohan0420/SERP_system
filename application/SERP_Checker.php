...
<body>
    <!-- <center>
        <script async src="https://cse.google.com/cse.js?cx=d1a497fe28e53450f">
        </script>
    ...
    <?php
        if (isset($_POST["domain"]) && isset($_POST["query"])){
            $GOOGLE_API_KEY = 'AIzaSyD4Z4rB1GJ-fiZqNCVgC3gK2AgQTejTIVc';
            $GOOGLE_CSE_CX = 'd1a497fe28e53450f';
